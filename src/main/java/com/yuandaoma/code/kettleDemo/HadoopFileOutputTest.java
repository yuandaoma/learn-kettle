...
public class HadoopFileOutputTest {
    ...
    public static void main(String[] args) throws Exception {
        try {
//            String path = Resources.getResource("").getPath();
//            System.out.println("path = " + path);
            System.setProperty("KETTLE_HOME","T:\\data-integration");
            StepPluginType.getInstance().getPluginFolders().add(new PluginFolder("T:\\code-kettle\\src\\main\\resources\\.kettle\\plugins",
                    true,false));
            ...
            cluster.setHdfsHost("192.168.20.200");
            cluster.setHdfsPort("8020");
            cluster.setName("node1");
            cluster.setHdfsUsername("");
            cluster.setHdfsPassword("");
            cluster.setJobTrackerHost("192.168.20.200");
            cluster.setJobTrackerPort("8032");
            ...
            setHadoopOutputMetaProperties(hadoopFileOutputMeta);
            ...
            StepMeta toStep = new StepMeta("HadoopFileOutputPlugin","HadoopFileOutputPlugin", hadoopFileOutputMeta);
    ...
    private static void setHadoopOutputMetaProperties(HadoopFileOutputMeta hadoopFileOutputMeta) {
        ...
        hadoopFileOutputMeta.setFileName("pentaho-hdfs://192.168.20.200:8020/" + date + "/bb");
